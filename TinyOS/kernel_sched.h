...
enum SCHED_CAUSE {
  ...
  SCHED_INIT              /** <The thread has just spawned.*/
};
...
/**
  ...
  An object of this type is associated to every thread. In this objectwakeup_time
...
typedef struct thread_control_block
{
  ...
  Thread_type type;       /**< The type of thread: IDLE or NORMAL */
 ...
 //Previous contexts. Looks back in time. Like calling functions in assembly.
  ...
  int detached; //0 for no, 1 for yes.
 int exitval;  

} TCB;


//Max iterations in the same priority queue.
#define MAX_PRIORITY_STAY 100
...
*/
//Maybe the prophecy is true. Maybe it is indeed true-true==false.
